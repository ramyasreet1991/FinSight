...
const IncomeIdeas: React.FC = () => {
  ...
  const filteredIdeas = incomeIdeas.filter(idea => idea.category === selectedCategory);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Income Generation Ideas</h2>
          <p className="text-gray-600">Explore various ways to generate additional income</p>
        </div>
            ...
            return (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => setSelectedIdea(null)} variant="outline">
                    Close
                  </Button>
                </div>
